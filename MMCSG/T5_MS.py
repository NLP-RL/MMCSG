...
class CustomDataset(Dataset):
    def __init__(self, data):
        self.data = data
        self.tokenizer = T5Tokenizer.from_pretrained("t5-base", model_max_length=480, max_length=480, truncation=True)
        self.max_length = 480
...
target_column = "dcs"  #For MCS, target_column = "One_line_patient_summary"
...
with torch.no_grad():
    for batch in test_loader:
        ...
        outputs = model.generate(input_ids=inputs, max_length=50)  # Adjust max_length as needed
